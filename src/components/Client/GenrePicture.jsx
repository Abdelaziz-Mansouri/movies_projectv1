...
const GenrePicture = (props) => {
  return (
    <div className='min-w-[273px] h-[356px] bg-cover rounded-[20px] flex flex-col justify-end pb-[45px] cursor-pointer' onClick={props.onClick} style={{ backgroundImage: `url(${Genre1})`}}>
